...
<dependency>
    ...
    <artifactId>{neo4j-java-driver-version}</artifactId>
</dependency>
----

Any 4.x version of the Driver will work, we currently test against {neo4j-java-driver-version}.
...
The coordinates of Project reactor are `io.projectreactor:reactor-core`. Those can be added in the appropriate form to a
Maven or Gradle project.
We test with {reactor-version} of Reactor and use their BOM module imported into dependency management instead of a fixed
