...
----
{groupId}:neo4j-cypher-dsl-codegen-ogm:{neo4j-cypher-dsl-version-latest}
----
...
----
dependencies {
    annotationProcessor '{groupId}:neo4j-cypher-dsl-codegen-ogm:{neo4j-cypher-dsl-version-latest}'
}
----
