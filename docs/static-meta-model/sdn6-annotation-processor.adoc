...
----
{groupId}:neo4j-cypher-dsl-codegen-sdn6:{neo4j-cypher-dsl-version-latest}
----
...
----
dependencies {
    annotationProcessor '{groupId}:neo4j-cypher-dsl-codegen-sdn6:{neo4j-cypher-dsl-version-latest}'
}
----
