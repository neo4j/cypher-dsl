...
[source,java,indent=0,tabsize=4]
----
include::../../neo4j-cypher-dsl-examples/src/test/java/org/neo4j/cypherdsl/examples/model/StaticModelIT.java[tag=work-with-properties]
----
...
[source,java,indent=0,tabsize=4]
----
include::../../neo4j-cypher-dsl-examples/src/test/java/org/neo4j/cypherdsl/examples/model/StaticModelIT.java[tag=deriving-new-properties]
----
...
[source,java,indent=0,tabsize=4]
----
include::../../neo4j-cypher-dsl-examples/src/test/java/org/neo4j/cypherdsl/examples/model/StaticModelIT.java[tag=query-node-by-properties]
----
...
[source,java,indent=0,tabsize=4]
----
include::../../neo4j-cypher-dsl-examples/src/test/java/org/neo4j/cypherdsl/examples/model/StaticModelIT.java[tag=query-rel-by-properties]
----
...
[source,java,indent=0,tabsize=4]
----
include::../../neo4j-cypher-dsl-examples/src/test/java/org/neo4j/cypherdsl/examples/model/StaticModelIT.java[tag=multiple-relationships]
----
...
[source,java,indent=0,tabsize=4]
----
include::../../neo4j-cypher-dsl-examples/src/test/java/org/neo4j/cypherdsl/examples/model/StaticModelIT.java[tag=chaining-relationships]
----
