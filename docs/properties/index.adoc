...
----
include::../../neo4j-cypher-dsl-examples/src/test/java/org/neo4j/cypherdsl/examples/core/PropertiesTest.java[tag=properties-on-nodes-and-rel]
----
...
[source,java,indent=0]
----
include::../../neo4j-cypher-dsl-examples/src/test/java/org/neo4j/cypherdsl/examples/core/PropertiesTest.java[tag=properties-on-expressions]
----
...
[source,java,indent=0]
----
include::../../neo4j-cypher-dsl-examples/src/test/java/org/neo4j/cypherdsl/examples/core/PropertiesTest.java[tag=nested-properties]
----
