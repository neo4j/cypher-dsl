...
----
include::../../neo4j-cypher-dsl-examples/src/test/java/org/neo4j/cypherdsl/examples/core/ArbitraryProceduresAndFunctionsTest.java[tag=standalone-call]
----
...
[source,java,indent=0]
----
include::../../neo4j-cypher-dsl-examples/src/test/java/org/neo4j/cypherdsl/examples/core/ArbitraryProceduresAndFunctionsTest.java[tag=standalone-call-with-args]
----
...
[source,java,indent=0]
----
include::../../neo4j-cypher-dsl-examples/src/test/java/org/neo4j/cypherdsl/examples/core/ArbitraryProceduresAndFunctionsTest.java[tag=standalone-call-yielding]
----
...
[source,java,indent=0]
----
include::../../neo4j-cypher-dsl-examples/src/test/java/org/neo4j/cypherdsl/examples/core/ArbitraryProceduresAndFunctionsTest.java[tag=standalone-call-where]
----
...
[source,java,indent=0]
----
include::../../neo4j-cypher-dsl-examples/src/test/java/org/neo4j/cypherdsl/examples/core/ArbitraryProceduresAndFunctionsTest.java[tag=in-query-calls]
----
...
[source,java,indent=0]
----
include::../../neo4j-cypher-dsl-examples/src/test/java/org/neo4j/cypherdsl/examples/core/ArbitraryProceduresAndFunctionsTest.java[tag=as-function]
----
...
[source,java,indent=0]
----
include::../../neo4j-cypher-dsl-examples/src/test/java/org/neo4j/cypherdsl/examples/core/ArbitraryProceduresAndFunctionsTest.java[tag=as-function-with-args]
----
<.> Same as before
...
Through `Cypher.call` any procedure or function can be called iin case one of your favorite procedures is missing in `org.neo4j.cypherdsl.core.Functions`.
