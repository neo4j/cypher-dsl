...
public final class NodeWithRecordProperties_ extends NodeBase<NodeWithRecordProperties_> {
	...
	public final RecordAsRelationship_ RECORD_AS_RELATIONSHIP = new RecordAsRelationship_(this, RecordTarget_.RECORD_TARGET);

	public NodeWithRecordProperties_() {
		super($PRIMARY_LABEL);
	}

	private NodeWithRecordProperties_(SymbolicName symbolicName, List<NodeLabel> labels,
	...
	public NodeWithRecordProperties_ withProperties(MapExpression newProperties) {
		return new NodeWithRecordProperties_(getSymbolicName().orElse(null), getLabels(), Properties.create(newProperties));
	}
}
