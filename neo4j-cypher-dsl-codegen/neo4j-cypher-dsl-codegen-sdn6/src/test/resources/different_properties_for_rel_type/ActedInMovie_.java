...
public final class ActedInMovie_ extends RelationshipBase<Person_, Movie_, ActedInMovie_> {
	...
	private ActedInMovie_(SymbolicName symbolicName, Node start, Properties properties,
			Node end) {
	...
	public ActedInMovie_ withProperties(MapExpression newProperties) {
		return new ActedInMovie_(getSymbolicName().orElse(null), getLeft(), Properties.create(newProperties), getRight());
	}
}