...
public final class MultipleLabels2_ extends NodeImpl<MultipleLabels2_> {
	public static final MultipleLabels2_ MULTIPLE_LABELS_2 = new MultipleLabels2_();

	public MultipleLabels2_() {
		super("PL", "Label1", "Label2");
	}

	private MultipleLabels2_(SymbolicName symbolicName, List<NodeLabel> labels,
