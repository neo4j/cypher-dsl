...
public class Query
    ...
    public static void checkNull(Object object, String name) {
        checkNull(object, name, null);
    }

    public static void checkNull(Object object, String name, String context) {
        if (isNull(object)) {
            if (context == null) {
                throw new IllegalArgumentException(name + " may not be null");
            } else {
                throw new IllegalArgumentException(name + " may not be null in context of: " + context);
