...
:neo4j-cypher-dsl-version: 2025.3.1-SNAPSHOT
// This is the latest released version, used only in the readme
:neo4j-cypher-dsl-version-latest: 2025.3.0
...
image:https://img.shields.io/maven-central/v/org.neo4j/neo4j-cypher-dsl?logo=apache-maven&style=flat-squareg[link=https://mvnrepository.com/artifact/org.neo4j/neo4j-cypher-dsl]
...
From version 2023.0.0 onwards, the minimal required Java version to use the Cypher-DSL is *Java 17*. If you need a version that is compatible with Java 8, please use 2022.9.x. JDK 26 is required to build Cypher-DSL.
