...
[abstract]
--
The Neo4j Cypher-DSL in its current form is a spin-off from Spring Data Neo4j⚡️RX (now Spring Data Neo4j 6+), where it is used to generate all Cypher queries.
