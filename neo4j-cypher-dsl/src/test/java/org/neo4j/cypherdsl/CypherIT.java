...
import static org.neo4j.cypherdsl.Conditions.*;
import static org.neo4j.cypherdsl.Cypher.*;
import static org.neo4j.cypherdsl.Functions.*;
import static org.neo4j.cypherdsl.Predicates.*;
...
class CypherIT {
	...
	class MapProjections {
		...
		void invalid() {
			...
			String expectedMessage = "FunctionInvocation{functionName='id'} of type class org.neo4j.cypherdsl.FunctionInvocation cannot be used with an implicit name as map entry.";
			assertThatIllegalArgumentException().isThrownBy(() -> {
				Node n = anyNode("n");
